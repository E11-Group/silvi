        ...
        <div class="icon-list__grid">
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/aprons.png"
                        alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    driveways aprons
                </h3>
                <a href="#" class="cover-link">screen-render-link</a>
            </div>
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/curbs.png" alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    Curbs sidewalks
                </h3>
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/decks.png" alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/concrete.png"
                        alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/pools.png" alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    Concrete pools
                </h3>
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/handscape.png"
                        alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    hardscape
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/stone.png" alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    landscape stone
                </h3>
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/block.png" alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    belgian block
                </h3>
            ...
            <div class="icon-list__item">
                <figure class="icon-list__media">
                    <img src="<?php echo get_template_directory_uri(); ?>/uploads/floors.png"
                        alt="Description of image">
                </figure>
                <h3 class="icon-list__item-title">
                    sheds pole barns garage floors
                </h3>
            </div>
        </div>
    </div>
</section>
<section class="grid-popup">
    <div class="container">
        <h2 class="grid-popup__title">past projects</h2>
    </div>
