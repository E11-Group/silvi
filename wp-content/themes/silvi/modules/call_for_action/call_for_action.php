 ...
 */
function e11_call_for_action($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'box'           => $get_field_type($prefix . 'cfa_section', $field_location),
            'module_id'     => $get_field_type( $prefix . 'cfa_module_id', $field_location),
        );
    else:
        $defaults = array(
            'box'          => array(),
    ...
    if (!empty($data['box'])):
        include 'tpl/call_for_action.tpl.php';
    endif;
