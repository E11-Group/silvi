 ...
 */
function e11_staff($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'staff_title', $field_location),
            'staff'         => $get_field_type($prefix . 'staff_staff', $field_location),
            'module_id'     => $get_field_type( $prefix . 'staff_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'         => false,
