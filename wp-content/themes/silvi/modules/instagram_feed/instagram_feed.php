 ...
 */
function e11_instagram_feed($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'insta_title', $field_location),
            'shortcode'     => $get_field_type($prefix . 'insta_shortcode', $field_location),
            'module_id'     => $get_field_type($prefix . 'insta_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'         => false,
    ...
    if (!empty($data['shortcode'])):
        include 'tpl/instagram_feed.tpl.php';
    endif;
