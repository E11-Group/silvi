 ...
 */
function e11_icons_grid_secondary($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'icgs_title', $field_location),
            'grid'          => $get_field_type($prefix . 'icgs_grid', $field_location),
            'module_id'     => $get_field_type( $prefix . 'icgs_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'         => false,
    ...
    if (!empty($data['grid'])):
        include 'tpl/icons_grid_secondary.tpl.php';
    endif;
