 ...
 */
function e11_featured_news($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'news'          => $get_field_type($prefix . 'fn_news', $field_location),
            'module_id'     => $get_field_type( $prefix . 'fn_module_id', $field_location),
        );
    else:
        $defaults = array(
            'news'          => array(),
    ...
    if (!empty($data['news'])):
        include 'tpl/featured_news.tpl.php';
    endif;
