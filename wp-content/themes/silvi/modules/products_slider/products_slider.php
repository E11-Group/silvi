 ...
 */
function e11_products_slider($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'pl_title', $field_location),
            'products'      => $get_field_type($prefix . 'pl_products', $field_location),
            'button'        => $get_field_type($prefix . 'pl_button', $field_location),
            'module_id'     => $get_field_type( $prefix . 'pl_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'         => false,
    ...
    if (!empty($data['products'])):
        include 'tpl/products_slider.tpl.php';
    endif;
