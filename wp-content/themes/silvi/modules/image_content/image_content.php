 ...
 */
function e11_image_content($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'columns'       => $get_field_type($prefix . 'ic_repeater', $field_location),
            'module_id'     => $get_field_type( $prefix . 'ic_module_id', $field_location),
        );
    else:
        $defaults = array(
            'columns'       => array(),
    ...
    if (!empty($data['columns'])):
        include 'tpl/image_content.tpl.php';
    endif;
