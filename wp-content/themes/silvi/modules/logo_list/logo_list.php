 ...
 */
function e11_logo_list($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'll_title', $field_location),
            'logos'         => $get_field_type($prefix . 'll_logos', $field_location),
            'module_id'     => $get_field_type( $prefix . 'll_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'        => false,
