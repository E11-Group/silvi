 ...
 */
function e11_timeline($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title'         => $get_field_type($prefix . 'tm_title', $field_location),
            'content'       => $get_field_type($prefix . 'tm_content', $field_location),
            'timeline'      => $get_field_type($prefix . 'tm_timeline', $field_location),
            'module_id'     => $get_field_type( $prefix . 'tm_module_id', $field_location),
        );
    else:
        $defaults = array(
            'title'        => false,
    ...
    if (!empty($data['timeline'] || ['title'] || ['content'])):
        include 'tpl/timeline.tpl.php';
    endif;
